...
**[Anexar print: Abas do gerenciamento de curso]**
...
**[Anexar print: Modal de confirmação de salvamento]**
...
**[Anexar print: Interface da aba Quiz com as duas sub-abas]**
...
**[Anexar print: Formulário de criação de quiz]**
...
**[Anexar print: Formulário de adição de questão]**
**[Anexar print: Lista de questões adicionadas]**
...
**[Anexar print: Ações de editar e remover questão]**
...
**[Anexar print: Interface do gerador de quiz]**
...
**[Anexar print: Barra de progresso durante geração]**
...
**[Anexar print: Lista de questões geradas com opções de editar/remover]**
...
**[Anexar print: Modal de configurações avançadas do gerador]**
...
**[Anexar print: Modal de configurações avançadas]**
...
**[Anexar print: Página de gerenciamento de avaliações]**
...
**[Anexar print: Modal de criação de avaliação]**
...
**[Anexar print: Interface de atribuição de notas]**
...
**[Anexar print: Tabela de notas gerais]**
...
**[Anexar print: Aba de alunos no gerenciamento do curso]**
...
**[Anexar print: Botão "Visão Geral de Notas"]**
...
**[Anexar print: Cards de métricas gerais]**
...
**[Anexar print: Tabela de desempenho dos alunos]**
...
**[Anexar print: Barra de filtros e busca]**
...
**[Anexar print: Modal de detalhes do aluno]**
...
**[Anexar print: Botão de exportação]**
...
**[Anexar print: Interface do Live Quiz - visão do professor]**
...
**[Anexar print: Questão sendo exibida no Live Quiz]**
...
**[Anexar print: Interface mostrando respostas dos alunos]**
...
**[Anexar print: Tela de ranking final]**
...
**[Anexar print: Interface do Custom Quiz]**
...
**[Anexar print: Configuração de PIN]**
**[Anexar print: Tela de solicitação de PIN para aluno]**
...
**Visualizar Reportes:**
- Alunos podem enviar **reportes** de problemas
- Visualize e responda feedbacks
- Melhore conteúdos com base nos reportes

**[Anexar print: Painel administrativo completo]**

### Sistema de Reportes

Os alunos podem reportar:
- Problemas técnicos (vídeo não carrega, quiz com erro)
- Questões com erro na resposta
- Sugestões de melhoria

**Como visualizar:**
1. Acesse **"Painel Administrativo"**
2. Clique em **"Gerenciar Reportes"**
3. Veja todos os reportes pendentes
4. Tome as ações necessárias

**[Anexar print: Lista de reportes]**
