      ...
      try {
        ...
        if (newPercentage >= 100 || isNearEnd) {
          if (!videoCompletedRef.current) {
            ...
            // Notificar o componente pai sobre 100% de progresso
        ...
        if (currentTime > watchTime) {
          ...
          if (
            ...
            // Notificar o componente pai sobre o progresso de 90%
            if (onVideoProgressUpdate) {
              onVideoProgressUpdate(videoId, newPercentage, true); // true indica que atingiu 90%
            }
          }
