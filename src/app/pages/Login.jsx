...
export default function SignInSide() {
  ...
  return (
      <Grid
        container
        component="main"
        sx={{ height: "100vh", backgroundColor: "#7D37A7", justifyContent: "center", alignItems: "center", p: { xs: 2, sm: 0 } }}
      >
        <Grid
          item
          xs={12}
        ...
        >
          ...
          >
            ...
            <Typography component="h1" variant="h5" fontFamily="Arial Unicode" fontWeight={800} fontSize={32} color={"#7D37A7"} marginBottom="16px">
