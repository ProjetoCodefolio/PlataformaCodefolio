...
const QuizSummary = ({
  ...
  // Usar o serviço para gerar o ranking
  const ranking = generateQuizRanking(quizResults, customQuestionResults);
  const podio = ranking.slice(0, 3);

  // Usar o serviço para processar resultados personalizados
  const processedCustomCorrect = processCustomQuizResults(
