...
import { processCustomQuizRanking } from "$api/services/courses/quizGigi";
...
const CustomQuizRanking = ({ onBack, customResults, liveQuizResults = {} }) => {
  ...
  // Usar o serviço para processar resultados
  const participantesOrdenados = processCustomQuizRanking(
    customResults,
    liveQuizResults
  );
