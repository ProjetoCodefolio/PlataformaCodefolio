...
import { listenToPostCount } from "$api/services/posts"; // Importar a função da API

export default function ProfileHeader({ selectedButton, onTimelineClick, onMembersClick, onFotosClick }) {
  const [postsLength, setPostsLength] = useState(0);

  useEffect(() => {
    const unsubscribe = listenToPostCount((count) => {
        ...
        <Box sx={{ textAlign: "center", mt: 8, mb: 2 }}>
          ...
          <Grid container justifyContent="center" spacing={2} sx={{ mt: 2 }}>
            <Grid item>
              ...
              <Typography component="div" variant="h6">{postsLength}</Typography>
            </Grid>
            <Grid item>
              <Typography component="div" variant="h6">
