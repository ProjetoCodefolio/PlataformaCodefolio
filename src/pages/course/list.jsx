...
const MyCourses = () => {
  ...
  useEffect(() => {
    // Pequeno delay para garantir que o componente está montado completamente
    const timer = setTimeout(() => {
      const errorMessage = sessionStorage.getItem('courseAccessError');
      if (errorMessage) {
        toast.error(errorMessage, {
          position: "top-right",
          autoClose: 5000, // Tempo em ms que o toast fica visível
          hideProgressBar: false,
          closeOnClick: true,
          pauseOnHover: true,
          draggable: true,
        });
        sessionStorage.removeItem('courseAccessError');
      }
    }, 500);
